...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/mad.png">
...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/mad1.png);">
        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/images/mad.png" width="175px" alt="Home" /></a>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12" style="position: relative;">
                            ...
                            <button id="eyeButton" class="eye-toggle-btn" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; padding: 0; cursor: pointer;"><i class="fa fa-eye-slash    "></i></button>
                        </div>
                    </div>
    ...
    <script>
    document.getElementById("eyeButton").addEventListener("click", function(event) {
...
<script>
    $(document).ready(function(){
        // Check if the login form has a feedback message
        var feedbackMessage = "<?php echo $this->session->flashdata('feedback'); ?>";
        if(feedbackMessage !== ""){
            // Display an alert if there's a feedback message
