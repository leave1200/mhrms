...
<?php $this->load->view('backend/sidebar'); ?>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="text" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control"placeholder="NID Number" name="nid" value="<?php echo $basic->em_nid; ?>" minlength="10" required pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}" required oninput="formatInput(this)"> 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
                                ...
                                <div class="tab-pane" id="password1" role="tabpanel">
                                    <div class="card-body">
                                                ...
                                                <div class="form-group col-md-6 m-t-20">
                                                        ...
                                                        <input type="password" class="form-control" name="new1" id="new1" required minlength="6">
                                                    </div>
                                                    <div class="form-group col-md-6 m-t-20">
                                                        <label>Confirm Password</label>
                                                        <input type="password" name="new2" id="new2" class="form-control" required minlength="6">
                                                        <button id="eyeButton" class="fa fa-eye-slash"></button>
                                                    </div>
				                                    <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                                    <?php } else { ?>
				                                    <div class="form-actions col-md-12">
                                           ...
                                           <div class="row">
                                            <div class="form-group col-md-6 m-t-5">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
                                                    ...
                                                    <input type="text" id="total" name="total" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line total" placeholder="Total Salary" value="<?php if(!empty($salaryvalue->total)) echo $salaryvalue->total ?>" minlength="3" required>
                                                </div>
                                                </div>
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
                                                    <label>Tax</label>
                                                    <input type="text" id="tax" name="tax" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="Tax" value="<?php if(!empty($salaryvalue->tax)) echo $salaryvalue->tax ?>" >
                                                </div>
			                                    <div class="form-group col-md-6 m-t-5">
        ...
        <!--<script type="text/javascript">
          ...
          $('.total').on('input',function() {
            var amount = parseInt($('.total').val());
            $('.tax').val((amount * .50 ? amount * .50 : 0).toFixed(2));
        });
          </script>-->
          <script>
    $(document).ready(function() {
        ...
        // Calculate tax on page load if total salary is already set
        calculateTax();

        // Event listener for changes in total salary input
        $('#total').on('input', function() {
            calculateTax();
        });
    });
